    ...
    <div class="container">
        ...
        <main class="main-content" id="main-content">
            ...
            <div class="login-form-container">
                ...
                <?php elseif (!empty($general_err) || !empty($username_err) || !empty($password_err) || !empty($captcha_err)): ?>
                ...
                <form class="login-form" action="index.php" method="POST">
                    ...
                    <div class="form-group captcha-group">
                        <label for="captcha">Enter captcha text as shown in image:</label>
                        <div class="captcha-display">
                            <img src="https://via.placeholder.com/100x40?text=596" alt="Captcha Image" class="captcha-image">
                        </div>
                    ...
                    <p class="create-account">
                        Don't have an account? <button type="submit" name="action" value="create_account" class="btn btn-link">Create Account</button>
                    </p>
                </form>
            </div>
        </main>
